...
namespace ServiceExpressDsk.GUI
{
    public partial class Main : Form
    {
        ...
        private void toolStripButton42_Click(object sender, EventArgs e)
        {
            ...
            dteJson dte = GenerarFactura();

            SerializarFactura(dte, path);
        }

        public static dteJson GenerarFactura()
        {
            ...
            try
            {
                ...
                nuevoJson = new dteJson {
                    ...
                    emisor = new emisor
                    {
                        nit = "22222222222219",
                        nrc = "9000089",
                        nombre = "SALVADOR CABALITO",
                        codActividad = "46900",
                        descActividad = "Ventaal por mayor de otrosproductos",
                    ...
                    cuerpoDocumento = new List<cuerpoDocumento>
                    {
                        new cuerpoDocumento
                        {
                            numItem = 1,
                            ...
                            codigo = null,
                            codTributo = null,
                            descripcion = "Servicio de consultoriacontable",
                            cantidad = 1,
                            uniMedida = 59,
                            precioUni = 2000,
                            montoDescu = 0,
        ...
        public static void SerializarFactura(dteJson dte, String path)
        {
            if (dte != null)
            {
                try
